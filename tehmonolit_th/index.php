    ...
    <div class="autopark_swiper swiper">
      <div class="slider_row swiper-wrapper">
        <div class="slider_item swiper-slide">
          <div class="img">
            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/slider_item.jpg" alt=""></a>
          </div>
          <div class="info">
        ...
        <div class="slider_item swiper-slide">
          <div class="img">
            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/4. Скания CIFA 31 с бетономиксером 9 куб.м.jpg" alt=""></a>
          </div>
          <div class="info">
            <p class="param">Вертикальный вылет - 24 м.</p>
            <a href=# class="name">Мерседес АТЕГО Schwing-24</p></a>
        ...
        <div class="slider_item swiper-slide">
          <div class="img">
            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/3. Мерседес АКТРАС Putzmeister-28.jpg" alt=""></a>
          </div>
          <div class="info">
            <p class="param">Вертикальный вылет - 24 м.</p>
            <a href=# class="name">Мерседес АТЕГО Schwing-24</p></a>
